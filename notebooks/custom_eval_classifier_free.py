...
config.name = "celeba256-male-genot-otclip-FiLM(All)-classifier-free"
...
params = eqx.tree_deserialise_leaves(os.path.join(check_folder_tree, f"latest_params.eqx"), params)
...
# x0 = x00.slice(slice(0, batch_size, None))    
