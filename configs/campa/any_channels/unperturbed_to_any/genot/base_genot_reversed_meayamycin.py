...
####
# OBJECTIVE: Observe reverse, out of curiosity
####
...
def get_config():
    ...
    config.name = f"any_channel_reverse_meayamycin"
    ...
    config.data.type_tgt=["184A1_unperturbed"]
    ...
    config.eval.checkpoint_metric = '184A1_unperturbed.[channel_umap__00_EU]-FID-target'
