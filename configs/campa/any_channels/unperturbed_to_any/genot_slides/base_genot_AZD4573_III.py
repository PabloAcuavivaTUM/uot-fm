...
def get_config():
    ...
    type_tgt = '184A1_AZD4573'
    config.name = f"{type_tgt}_base_genot_III"
    ...
    config.eval.checkpoint_metric = f'{type_tgt}.[channel_umap__00_EU]-FID-target'
