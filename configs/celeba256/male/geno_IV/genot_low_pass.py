...
def get_config():
    ...
    config.name = f"celeba256-male-genot-otclip-FiLM(All)-LowPass"
    ...
    config.data.low_pass_filter = low_pass_filter = ml_collections.ConfigDict()
    
    low_pass_filter.method = 'downsample' 
    low_pass_filter.scale_factor= 0.5

    config.training.compare_on = "low_freq_data"
    config.training.ot_cost_fn = "euclidean"
