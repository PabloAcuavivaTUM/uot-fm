...
def get_config():
    ...
    batch_size_matching = 256
    
    config.training.batch_size = 256
    config.training.pointcloud_batch_size = 256
    config.training.batch_size_matching = batch_size_matching

    config.name = f"celeba256-male-genot-otclip-batch_size_matching{batch_size_matching}-PointCloudBatch256"
